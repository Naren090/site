      ...
      <div>
        ...
        <Table selectable={false} height="220px" style={{ border: '1px solid rgb(224, 224, 224)' }}>
          <TableHeader displaySelectAll={false} adjustForCheckbox={false}>
            <TableRow>
              <TableHeaderColumn style={{ textAlign: 'center' }}>Version</TableHeaderColumn>
              <TableHeaderColumn style={{ textAlign: 'center' }}>Mode</TableHeaderColumn>
              <TableHeaderColumn style={{ width: 24, textAlign: 'center' }}>Activate</TableHeaderColumn>
